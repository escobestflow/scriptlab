...
export default function Page() {
  ...
  // as both the loading screen AND the signed-out sign-in surface: if no
  // session exists at the end of the animation a Google sign-in button
  // fades in; if a session is already present the splash auto-dismisses.
  // The sessionStorage flag keeps it from re-running if the user pops
  // back out to the root route mid-session.
