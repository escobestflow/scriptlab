...
export default function Page() {
  ...
  // Edge case: user signed out mid-session. Show a minimal re-auth
  // surface rather than replaying the full 6.59s intro.
  if (!user) {
    return (
      <div className="app" style={{ alignItems: "center", justifyContent: "center", padding: "0 40px", textAlign: "center" }}>
        ...
        <div className="caption" style={{ marginBottom: 24, maxWidth: 260 }}>
          Signed out. Sign back in to continue.
        </div>
        <Button
          variant="primary"
          size="lg"
